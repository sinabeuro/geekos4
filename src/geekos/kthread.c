...
//struct Sched_Algo roundRobin = { Get_Next_Runnable_RR, Make_Runnable_RR, Switch_To_MLF };
//struct Sched_Algo multiLevelFeedback = { Get_Next_Runnable_MLF, Make_Runnable_MLF, Switch_To_RR };

//struct Sched_Algo s_algorithm = multiLevelFeedback;
